...
public class LeagueController {
    ...
    public ResponseEntity<ApiResponse> deleteUser(@PathVariable Integer id) {
        ...
        return ResponseEntity.status(200).body(new ApiResponse("League deleted  !", 200));
    }
    ...
    public ResponseEntity<ApiResponse> updateLeague(@PathVariable Integer id, @RequestBody @Valid League league) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse("League updated", 200));
    }
